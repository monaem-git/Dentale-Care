...
<!-- Mirrored from demo.themeamber.com/dentalcare/gallery/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Aug 2016 22:23:20 GMT -->
...
<head>
    ...
    <title>Gallery &#8211; Dental Care</title>
...
<script type='text/javascript'>
/* <![CDATA[ */
var wc_add_to_cart_params = {"ajax_url":"\/dentalcare\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/dentalcare\/gallery\/?wc-ajax=%%endpoint%%","i18n_view_cart":"View Cart","cart_url":"http:\/\/demo.themeamber.com\/dentalcare\/cart\/","is_cart":"","cart_redirect_after_add":"no"};
/* ]]> */
</script>
...
<link rel='shortlink' href='../indexc39e.html?p=203' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed6903.json?url=http%3A%2F%2Fdemo.themeamber.com%2Fdentalcare%2Fgallery%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embede328?url=http%3A%2F%2Fdemo.themeamber.com%2Fdentalcare%2Fgallery%2F&amp;format=xml" />
...
<ul class="sub-menu">
    ...
    <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-208 current_page_item  menu-item-454"><a href="index.php">Gallery</a></li>
...
<div id="post-203" class="post-203 page type-page status-publish hentry">
	<div class="entry-content">
		<div class="vc_row wpb_row vc_row-fluid vc_custom_1466051258335"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="ab-grid-wrap gallery-popup-wrap ab-grid-portfolio ">

        <div class="ab-custom-heading-layout1 clearfix">
        <h2 class="ab-heading-title">
            <span>NEWS &amp; BLOG</span>

            <ul class="ab-grid-filter list-unstyled list-inline right">
                <li><a class="active" href="#" data-group="all"><span>All</span></a></li>
                                                        <li><a href="#" data-group="category-implants">
                            <span>Implants</span>
                        </a>
                    </li>
                                                        <li><a href="#" data-group="category-surgery">
                            <span>Surgery</span>
                        </a>
                    </li>
                            </ul>
    ...
    <div class="ab-grid" style="margin:0 -15px">
                    <div style="padding:15px" class="clearfix ab-grid-item col-lg-6 col-md-6 col-sm-6 col-xs-12" data-groups='["all"]'>
                <div class="ab-grid-item-wrap">
                    <div class="ab-grid-image-wrap">
                    <div class="ab-grid-media  has-thumbnail"><img width="840" height="433" src="../wp-content/uploads/2016/06/g12-1000x515.jpg" class="attachment-large size-large wp-post-image" alt="g12" /></div>                        <div class="ab-grid-content-wrap">
                            <div class="ab-grid-title montserrat-bold-50">
                                Our Hospital                            </div>
                ...
                <div class="ab-grid-item-wrap">
                    <div class="ab-grid-image-wrap">
                    <div class="ab-grid-media  has-thumbnail"><img width="840" height="433" src="../wp-content/uploads/2016/06/g11-1000x515.jpg" class="attachment-large size-large wp-post-image" alt="g11" /></div>                        <div class="ab-grid-content-wrap">
                            <div class="ab-grid-title montserrat-bold-50">
                                Patients                            </div>
                            <div class="ab-grid-content">
                                Lorem ipsum dolor sit amet consecte                            </div>
                ...
                <div class="ab-grid-item-wrap">
                    <div class="ab-grid-image-wrap">
                    <div class="ab-grid-media  has-thumbnail"><img width="840" height="433" src="../wp-content/uploads/2016/06/g10-1000x515.jpg" class="attachment-large size-large wp-post-image" alt="g10" /></div>                        <div class="ab-grid-content-wrap">
                            <div class="ab-grid-title montserrat-bold-50">
                                Patients                            </div>
                            <div class="ab-grid-content">
                                Ipsum dolor sit amet consecte                            </div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="ab-grid-item-wrap">
                    <div class="ab-grid-image-wrap">
                    <div class="ab-grid-media  has-thumbnail"><img width="840" height="433" src="../wp-content/uploads/2016/06/g9-1000x515.jpg" class="attachment-large size-large wp-post-image" alt="g9" /></div>                        <div class="ab-grid-content-wrap">
                            <div class="ab-grid-title montserrat-bold-50">
                                Surgery                            </div>
                            <div class="ab-grid-content">
                                Ipsum dolor sit amet consecte                            </div>
                ...
                <div class="ab-grid-item-wrap">
                    <div class="ab-grid-image-wrap">
                    <div class="ab-grid-media  has-thumbnail"><img width="840" height="433" src="../wp-content/uploads/2016/06/g8-1000x515.jpg" class="attachment-large size-large wp-post-image" alt="g8" /></div>                        <div class="ab-grid-content-wrap">
                            <div class="ab-grid-title montserrat-bold-50">
                                Our Doctors                            </div>
                            <div class="ab-grid-content">
                                Ipsum dolor sit amet consecte                            </div>
                ...
                <div class="ab-grid-item-wrap">
                    <div class="ab-grid-image-wrap">
                    <div class="ab-grid-media  has-thumbnail"><img width="840" height="433" src="../wp-content/uploads/2016/06/g7-1000x515.jpg" class="attachment-large size-large wp-post-image" alt="g7" /></div>                        <div class="ab-grid-content-wrap">
                            <div class="ab-grid-title montserrat-bold-50">
                                Our Doctors                            </div>
                            <div class="ab-grid-content">
                                Ipsum dolor sit amet consecte                            </div>
                ...
                <div class="ab-grid-item-wrap">
                    <div class="ab-grid-image-wrap">
                    <div class="ab-grid-media  has-thumbnail"><img width="840" height="433" src="../wp-content/uploads/2016/06/g6-1000x515.jpg" class="attachment-large size-large wp-post-image" alt="g6" /></div>                        <div class="ab-grid-content-wrap">
                            <div class="ab-grid-title montserrat-bold-50">
                                Doctor                            </div>
                            <div class="ab-grid-content">
                                Lorem ipsum dolor sit amet consecte                            </div>
                ...
                <div class="ab-grid-item-wrap">
                    <div class="ab-grid-image-wrap">
                    <div class="ab-grid-media  has-thumbnail"><img width="840" height="433" src="../wp-content/uploads/2016/06/g5-1000x515.jpg" class="attachment-large size-large wp-post-image" alt="g5" /></div>                        <div class="ab-grid-content-wrap">
                            <div class="ab-grid-title montserrat-bold-50">
                                Patients                            </div>
                            <div class="ab-grid-content">
                                Lorem ipsum dolor sit amet consecte                            </div>
                        ...
                        <div style="padding:15px" class="clearfix ab-grid-item col-lg-6 col-md-6 col-sm-6 col-xs-12" data-groups='["all","category-surgery"]'>
                <div class="ab-grid-item-wrap">
                    <div class="ab-grid-image-wrap">
                    <div class="ab-grid-media  has-thumbnail"><img width="840" height="433" src="../wp-content/uploads/2016/06/g4-1000x515.jpg" class="attachment-large size-large wp-post-image" alt="g4" /></div>                        <div class="ab-grid-content-wrap">
                            <div class="ab-grid-title montserrat-bold-50">
                                Surgery                            </div>
                            <div class="ab-grid-content">
                                Lorem ipsum dolor sit amet consecte                            </div>
                ...
                <div class="ab-grid-item-wrap">
                    <div class="ab-grid-image-wrap">
                    <div class="ab-grid-media  has-thumbnail"><img width="800" height="515" src="../wp-content/uploads/2016/06/g3-800x515.jpg" class="attachment-large size-large wp-post-image" alt="g3" /></div>                        <div class="ab-grid-content-wrap">
                            <div class="ab-grid-title montserrat-bold-50">
                                Patients                            </div>
                            <div class="ab-grid-content">
                                Lorem ipsum dolor sit amet consecte                            </div>
                ...
                <div class="ab-grid-item-wrap">
                    <div class="ab-grid-image-wrap">
                    <div class="ab-grid-media  has-thumbnail"><img width="840" height="433" src="../wp-content/uploads/2016/06/g2-1000x515.jpg" class="attachment-large size-large wp-post-image" alt="g2" /></div>                        <div class="ab-grid-content-wrap">
                            <div class="ab-grid-title montserrat-bold-50">
                                Patients                            </div>
                            <div class="ab-grid-content">
                                Lorem ipsum dolor sit amet consecte                            </div>
                        ...
                        <div style="padding:15px" class="clearfix ab-grid-item col-lg-6 col-md-6 col-sm-6 col-xs-12" data-groups='["all","category-implants"]'>
                <div class="ab-grid-item-wrap">
                    <div class="ab-grid-image-wrap">
                    <div class="ab-grid-media  has-thumbnail"><img width="840" height="433" src="../wp-content/uploads/2016/06/g1-1000x515.jpg" class="attachment-large size-large wp-post-image" alt="g1" /></div>                        <div class="ab-grid-content-wrap">
                            <div class="ab-grid-title montserrat-bold-50">
            		...
            		<!-- sizer -->
		<div class="ab-grid-item col-lg-6 col-md-6 col-sm-6 col-xs-12 shuffle_sizer"></div>
    </div>
</div></div></div></div></div>
			</div><!-- .entry-content -->
...
<ul class="sub-menu">
    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-20"><a href="../blog/index.php">Blog</a></li>
    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-454"><a href="index.php">Gallery</a></li>
    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-465"><a href="../appointment/index.php">Appointment</a></li>
</ul>
</li>
...
<script type='text/javascript'>
/* <![CDATA[ */
var woocommerce_params = {"ajax_url":"\/dentalcare\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/dentalcare\/gallery\/?wc-ajax=%%endpoint%%"};
/* ]]> */
</script>
...
<script type='text/javascript'>
/* <![CDATA[ */
var wc_cart_fragments_params = {"ajax_url":"\/dentalcare\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/dentalcare\/gallery\/?wc-ajax=%%endpoint%%","fragment_name":"wc_fragments"};
/* ]]> */
</script>
...
<!-- Mirrored from demo.themeamber.com/dentalcare/gallery/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Aug 2016 22:23:33 GMT -->
</html>
