...
<li id="menu-item-25" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-7 current_page_item menu-item-25"><a href="index.php">Services</a></li>
            ...
            <div class="site-page-title-main ab-flex">
                <div class="ab-page-title ab-flex-box">
                            ...
                            <span>Services</span>
                             ...
                             style="color: ;">
                            <span>Dentalcare’s dental services</span>
                        </div>
                                    </div>
...
<div id="post-7" class="post-7 page type-page status-publish hentry">
	<div class="entry-content">
		<div class="vc_row wpb_row vc_row-fluid vc_custom_1465812155262"><div class="wpb_column vc_column_container vc_col-sm-3"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="ab-feature-box-wraper ab-feature-box-layout1 text-center " style="margin-top: ">
    <div class="ab-feature-box secondary-background-hover secondary-border">
        <div class="ab-feature-box-icon">
                                        <div class="feature-box-image" style="padding:2px 0">
                    <img class="fb-image" src="../wp-content/uploads/2016/05/Cosmetic-dentistry-2.png" alt="" />
                    <img class="fb-image-hover" src="../wp-content/uploads/2016/05/Cosmetic-dentistry.png" alt="" />
                </div>
                    </div>

                    <h3><a href="#">Cosmetic dentistry</a></h3>
            </div>
</div></div></div></div><div class="wpb_column vc_column_container vc_col-sm-3"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="ab-feature-box-wraper ab-feature-box-layout1 text-center " style="margin-top: ">
    <div class="ab-feature-box secondary-background-hover secondary-border">
        <div class="ab-feature-box-icon">
                                        <div class="feature-box-image" style="padding:2px 0">
                    <img class="fb-image" src="../wp-content/uploads/2016/05/Oral-Surgery-2.png" alt="" />
                    <img class="fb-image-hover" src="../wp-content/uploads/2016/05/Oral-Surgery.png" alt="" />
                </div>
                    </div>

                    <h3><a href="#">Dental bridges</a></h3>
            </div>
</div></div></div></div><div class="wpb_column vc_column_container vc_col-sm-3"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="ab-feature-box-wraper ab-feature-box-layout1 text-center " style="margin-top: ">
    <div class="ab-feature-box secondary-background-hover secondary-border">
        <div class="ab-feature-box-icon">
                                        <div class="feature-box-image" style="padding:6px 0">
                    <img class="fb-image" src="../wp-content/uploads/2016/05/Modern-Anesthetic-2.png" alt="" />
                    <img class="fb-image-hover" src="../wp-content/uploads/2016/05/Modern-Anesthetic.png" alt="" />
                </div>
                    </div>

                    <h3><a href="#">Dental crowns</a></h3>
            </div>
</div></div></div></div><div class="wpb_column vc_column_container vc_col-sm-3"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="ab-feature-box-wraper ab-feature-box-layout1 text-center " style="margin-top: ">
    <div class="ab-feature-box secondary-background-hover secondary-border">
        <div class="ab-feature-box-icon">
                                        <div class="feature-box-image" style="padding:">
                    <img class="fb-image" src="../wp-content/uploads/2016/05/Extractions-of-teeth-2.png" alt="" />
                    <img class="fb-image-hover" src="../wp-content/uploads/2016/05/Extractions-of-teeth.png" alt="" />
                </div>
                    </div>

                    <h3><a href="#">Extractions of teeth</a></h3>
            </div>
</div></div></div></div></div><div class="vc_row wpb_row vc_row-fluid vc_custom_1465812164519"><div class="wpb_column vc_column_container vc_col-sm-3"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="ab-feature-box-wraper ab-feature-box-layout1 text-center " style="margin-top: ">
    <div class="ab-feature-box secondary-background-hover secondary-border">
        <div class="ab-feature-box-icon">
                                        <div class="feature-box-image" style="padding:7px 0">
                    <img class="fb-image" src="../wp-content/uploads/2016/05/Gum-disease-2.png" alt="" />
                    <img class="fb-image-hover" src="../wp-content/uploads/2016/05/Gum-disease.png" alt="" />
                </div>
                    </div>
    ...
    <div class="ab-feature-box secondary-background-hover secondary-border">
        <div class="ab-feature-box-icon">
                                        <div class="feature-box-image" style="padding:">
                    <img class="fb-image" src="../wp-content/uploads/2016/05/Dental-Implants-2.png" alt="" />
                    <img class="fb-image-hover" src="../wp-content/uploads/2016/05/Dental-Implants.png" alt="" />
                </div>
                    </div>

                    <h3><a href="#">Dental implant </a></h3>
            </div>
</div></div></div></div><div class="wpb_column vc_column_container vc_col-sm-3"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="ab-feature-box-wraper ab-feature-box-layout1 text-center " style="margin-top: ">
    <div class="ab-feature-box secondary-background-hover secondary-border">
        <div class="ab-feature-box-icon">
                                        <div class="feature-box-image" style="padding:6px 0">
                    <img class="fb-image" src="../wp-content/uploads/2016/05/Root-canal-2.png" alt="" />
                    <img class="fb-image-hover" src="../wp-content/uploads/2016/05/Root-canal.png" alt="" />
                </div>
                    </div>
    ...
    <div class="ab-feature-box secondary-background-hover secondary-border">
        <div class="ab-feature-box-icon">
                                        <div class="feature-box-image" style="padding:6px 0 7px">
                    <img class="fb-image" src="../wp-content/uploads/2016/05/The-dental-hygienist-2.png" alt="" />
                    <img class="fb-image-hover" src="../wp-content/uploads/2016/05/The-dental-hygienist.png" alt="" />
                </div>
                    </div>

                    <h3><a href="#">The dental hygienist</a></h3>
            </div>
</div></div></div></div></div><div class="vc_row wpb_row vc_row-fluid vc_custom_1465871387537"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="ab-custom-heading-wraper ab-custom-heading-layout1 text-default " style="margin-bottom: 32px;">
    <h2 class="ab-heading-title" style="color: ; font-size: ;">
        <span class="heading-text"> Dental bridges</span>
    </h2>
</div>
...
</div></div></div></div><div class="vc_row wpb_row vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="ab-custom-heading-wraper ab-custom-heading-layout2 text-default " style="margin-bottom: 17px;">
            <div class="ab-sub-heading" style="color: #515151; text-transform: ;">
        Dental Bridge Case study    </div>
    </div>
	<div class="wpb_text_column wpb_content_element ">
		<div class="wpb_wrapper">
	...
	<div class="wpb_single_image wpb_content_element vc_align_left  vc_custom_1465871970247">
		
		<figure class="wpb_wrapper vc_figure">
			<div class="vc_single_image-wrapper   vc_box_border_grey"><img width="1106" height="204" src="../wp-content/uploads/2016/05/dental-bridge.png" class="vc_single_image-img attachment-full" alt="dental-bridge" srcset="http://demo.themeamber.com/dentalcare/wp-content/uploads/2016/05/dental-bridge.png 1106w, http://demo.themeamber.com/dentalcare/wp-content/uploads/2016/05/dental-bridge-768x142.png 768w" sizes="(max-width: 1106px) 100vw, 1106px" /></div>
		</figure>
	</div>
</div></div></div></div><div class="vc_row wpb_row vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="ab-custom-heading-wraper ab-custom-heading-layout2 text-default " style="margin-bottom: ;">
            <div class="ab-sub-heading" style="color: #515151; text-transform: ;">
        Reviews about Dental Bridge    </div>
...
</div></div></div></div></div><div class="vc_row wpb_row vc_row-fluid vc_custom_1465873897847"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="ab-message-wraper ab-message-layout1 ">

    <div class="ab-message-inner clearfix">
        <div class="ab-message clearfix">
            Ut enim ad minim veniam, quis nostrud exercitation ullamco Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.
                            <div class="rating">
                ...
                <div class="ab-message-image-social left">
                                                                <div class="ab-message-image">
                            <img alt="" src="../wp-content/uploads/2016/05/test2.jpg" />
                        </div>
                                    </div>
                <div class="ab-message-meta-postion left">
                    <h3 class="ab-message-name montserrat-bold-50">
