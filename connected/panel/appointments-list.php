										...
										<table class="table user-list">
                                            ...
                                            try {
                                            ...
                                            catch (Exception $e) 
                                                {
	                                               ...
	                                               $reponse=$bdd->query("SELECT * FROM appointments WHERE  confirmed = '$confirmed' ");
											...
											<tbody><?php echo'
												<tr>
													...
													<td style="width: 20%;">
														...
														<a  id="confirm_btn';echo $donnees["id"] ; echo'0" class="table-link " onclick="myFunction(\'confirm_btn';echo $donnees["id"] ; echo'\')">
															<span class="fa-stack">
																<i class="fa fa-square fa-stack-2x"></i>
                                                    ...
                                                    if(isset($_POST['delete_btn'.$id1]))
                                                    {
                                                        ...
                                                        $idd =$donnees["id"];
                                                       $reponse1=$bdd->query("DELETE FROM appointments WHERE id = '$idd'");
                                                    ...
                                                    echo'
                                                        ...
                                                        <form method=\'POST\' action=\'appointments-list.php?confirmed='.$_GET['confirmed'].'\'>
                                                        <button name="confirm_btn';echo $donnees["id"] ; echo'" id="confirm_btn';echo $donnees["id"] ; echo'"  class="btn btn-info" style="visibility:hidden">
									                       Yes ,Confirm this appointment';
									                       $id1 =$donnees["id"];
                                                    if(isset($_POST['confirm_btn'.$id1]))
                                                    {
                                                     
                                                        $idd =$donnees["id"];
                                                       $reponse1=$bdd->query("UPDATE appointments SET Confirmed = 1 WHERE id = '$idd'");
                                                        redirectTo('appointments-list.php?confirmed='.$_GET['confirmed']);
                                                        $reponse1->closeCursor(); 
