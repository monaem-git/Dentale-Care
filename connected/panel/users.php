									...
									<div class="table-responsive">
										<table class="table user-list">
                                            ...
                                            $position = $_GET['position'];
	                                               $reponse=$bdd->query("SELECT * FROM users WHERE  position = '$position' ");
											...
											<tbody><?php echo'
												<tr>
													<td>
														...
														<a href="#" class="user-link">';  echo $donnees["firstName"].' '.$donnees["lastName"] ; echo'</a>
														<span class="user-subhead">'.$_GET['position'].'<br>'; if ($_GET['position'] == 'doctor') { echo $donnees['speciality'];} echo '</span>
													</td>
													<td>
														';
													...
													<td class="text-center">';
														echo $donnees["phoneNumber"] ;
                                                    echo'
													</td>
													<td>
														<a href="#">';echo $donnees["email"] ; echo'</a>
													</td>
													<td style="width: 20%;">
														<a href="user-profile.php?id=';echo $donnees["id"] ; echo'" class="table-link">
															<span class="fa-stack">
                                                    ...
                                                    <td>
                                                        <form method=\'POST\' action=\'users.php?position='.$_GET['position'].'\'>
                                                        <button name="delete_btn';echo $donnees["id"] ; echo'" id="delete_btn';echo $donnees["id"] ; echo'"  class="btn btn-danger" style="visibility:hidden">
									                       Yes ,delete this ';echo $donnees["position"] ; echo'</button>';  
                                                    $id1 =$donnees["id"];
                                                    if(isset($_POST['delete_btn'.$id1]))
                                                    {
                                                     
                                                        $idd =$donnees["id"];
                                                       $reponse1=$bdd->query("DELETE FROM users WHERE id = '$idd'");
                                                        redirectTo('users.php?position='.$_GET['position']);
